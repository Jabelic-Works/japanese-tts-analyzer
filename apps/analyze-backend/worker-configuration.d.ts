/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f38ebfc271c03f58e7855c7d2f43f9f5)
// Runtime types generated with workerd@1.20260317.1 2026-03-30 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AnalyzeContainer";
	}
	interface Env {
		ANALYZE_API_BASE_URL: string;
		ANALYZE_CONTAINER: DurableObjectNamespace<import("./src/worker").AnalyzeContainer>;
	}
}
